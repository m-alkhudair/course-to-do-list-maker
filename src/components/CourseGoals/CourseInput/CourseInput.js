...
const CourseInput = (props) => {
  ...
  return (
    <form onSubmit={formSubmitHandler}> 
      ...
      {/* <FormControl invalid={!isValid}> LAST STEP: commenting this out and going back to div but with CSS MODULES */} 

      {/* PAY CLOSE ATTENTION TO THE CLASSNAME ATTRIBUTE AND HOW WE HAVE TO USE STYLE AS AN OBJ */}
